    ...
    public partial class ASM : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ComboFoodItem", x => new { x.CombosComboId, x.FoodItemsFoodItemId });
                    table.ForeignKey(
                        name: "FK_ComboFoodItem_Combos_CombosComboId",
                        column: x => x.CombosComboId,
                        principalTable: "Combos",
                        principalColumn: "ComboId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ComboFoodItem_FoodItems_FoodItemsFoodItemId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Reviews", x => new { x.UserId, x.FoodItemId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ComboFoodItem_FoodItemsFoodItemId",
                table: "ComboFoodItem",
